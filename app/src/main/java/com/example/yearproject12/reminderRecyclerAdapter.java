...
ArrayList<String> parentIDs;
    ...
    public reminderRecyclerAdapter(Context context, ArrayList<TestReminder> reminderList, ArrayList<String> parentIDs){
    ...
    //assign values to rows
        ...
        holder.time.setText(reminderList.get(position).getTime().toString());
        ...
        holder.button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                 ...
                 DatabaseReference reminder = database.getReference().child("Reminders");

                Query query = reminder.orderByChild("title");

                ((MainActivity)context).cancelAlarm(position);

                Log.d("DEBUG", "onClick: this is what alarm is getting deleted "+ position );
